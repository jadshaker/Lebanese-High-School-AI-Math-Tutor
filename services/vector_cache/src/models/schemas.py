...
# === Interaction Node Schemas ===
# Nodes store user_input (what user said) + system_response (what system replied)
# Nodes are embedded by user_input for similarity matching
...
class SearchChildrenRequest(BaseModel):
    ...
    question_id: str = Field(..., description="Question ID (required if parent_id is null)")
