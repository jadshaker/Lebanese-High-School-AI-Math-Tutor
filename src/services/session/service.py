...
async def delete_session(session_id: str, request_id: str = "") -> bool:
    """Delete a session."""
    async with _lock:
...
async def get_tutoring_state(session_id: str) -> Optional[TutoringState]:
